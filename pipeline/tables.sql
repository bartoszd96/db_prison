...
CREATE TABLE CELE (
 ...
 id_placowki INTEGER NOT NULL REFERENCES PLACOWKI(id_plackowki),
...
CREATE TABLE WIEZNIOWIE (
 id_wieznia INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE KONTRAHENCI (
 id_kontrahenta INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
 id_odbiorcy INTEGER NOT NULL REFERENCES ODBIORCY(id_odbiorcy),
